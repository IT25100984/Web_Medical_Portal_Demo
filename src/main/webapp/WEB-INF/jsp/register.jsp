...
<head>
    ...
    <title>Register | ProjectMASSx</title>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <form:password path="password_hash" id="password" cssClass="form-control" placeholder="Create a password" minlength="6" autocomplete="new-password" required="required" />
                        ...
                        <form:errors path="password_hash" cssClass="text-danger small d-block mt-1" />
